...
KWin executable/library. The current implementation is **pointer-only**.
...
Host focus is explicit; host keyboard and XWayland input are not implemented.
...
compose arbitrary subsurfaces, decorations or effects. Keyboard control, clipboard,
...
Current desktop update: `computerartist-host-21068884b144` is loaded for this login.
...
For this login use `computerartist-host-21068884b144` in the unload command below.
